...
**Purpose: This php makes a curl request to the middle (test_case_middle.php) to access question resources
*/
...
curl_setopt_array($curl, array(
  CURLOPT_URL => "https://web.njit.edu/~mga25/cs_490/app/controllers/test_case/test_case_middle.php",
